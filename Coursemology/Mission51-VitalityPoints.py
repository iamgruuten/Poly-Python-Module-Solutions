...
def check_gift(distance):
    ...
    if distance < 25:
        gift = "Popular eVoucher"
        value = 2
    elif distance < 50:
        gift = "Cold Storage eVoucher"
        value = 5
    elif distance < 75:
        gift = "Starbucks eVoucher"
        value = 10
    else:
        gift = "Subway eVoucher"
        value = 20
    
    print("{} for the {}".format(value, gift)) #Modify to display gift to be given
